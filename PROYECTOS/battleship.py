...
# si lo quiero de tamaño pongo "lado = 10" (10x10) o como yo quiera de grande en PASO 9
...
==============================================================================================
            ...
            print("¡Izad las velas mis valientes marineros!")
            salir = True
...
while True:
    ...
    if ver_tablero_contrincante == "si":
        ...
        print(f"No pienso hacer trampas con {contrincante}.\n")
...
tablero_jugador = (crea_barco_aleatorio(tablero_jugador, eslora = 2))   # 3 barcos de 2m eslora
tablero_jugador = (crea_barco_aleatorio(tablero_jugador, eslora = 2))
tablero_jugador = (crea_barco_aleatorio(tablero_jugador, eslora = 2))
tablero_jugador = (crea_barco_aleatorio(tablero_jugador, eslora = 3))   # 2 naves de 3m eslora
tablero_jugador = (crea_barco_aleatorio(tablero_jugador, eslora = 3))
tablero_jugador = (crea_barco_aleatorio(tablero_jugador, eslora = 4))   # 1 buque de 4m de eslora
print(f"\nTablero de {jugador}\n\n{tablero_jugador}\n\n")

tablero_contrincante = (crea_barco_aleatorio(tablero_contrincante, eslora = 2))   # 3 barcos de 2m eslora
tablero_contrincante = (crea_barco_aleatorio(tablero_contrincante, eslora = 2))
tablero_contrincante = (crea_barco_aleatorio(tablero_contrincante, eslora = 2))
tablero_contrincante = (crea_barco_aleatorio(tablero_contrincante, eslora = 3))   # 2 naves de 3m eslora
tablero_contrincante = (crea_barco_aleatorio(tablero_contrincante, eslora = 3))
tablero_contrincante = (crea_barco_aleatorio(tablero_contrincante, eslora = 4))   # 1 buque de 4m de eslora
if ver_tablero_contrincante == True:
    print(f"\nTablero de {contrincante}\n\n{tablero_contrincante}\n\n") 
...
while not False in tablero_jugador or not False in tablero_contrincante:
...
if False in tablero_jugador:        # si todas las casillas son falsas, es que no te quedan barcos
    print(f"GAME OVER\n{jugador} se perdió en el Pacífico.")

elif False in tablero_contrincante:
